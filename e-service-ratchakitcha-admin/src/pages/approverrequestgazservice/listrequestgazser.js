      ...
      <LayoutAfterLogin>
        <div className="my-4 py-8 px-8 shadow-lg rounded-xl border border-[#efece3] flex flex-col">
          <span className="text-xl">
            อนุมัติคำร้องขอรับบริการข้อมูลราชกิจจานุเบกษา
          </span>
          <hr className="my-5" />
          ...
          <div className="my-4 py-4 px-8 shadow-lg rounded-xl border border-[#efece3] flex flex-col">
                  ...
                  <tr className="bg-[#efece3] shadow-md gap-4">
                    ...
                    <th className="px-1 py-2 rounded-e-xl w-[5%]">
                      <div className="flex justify-center">
                        <button
                          className="bg-[#C8E6C9] text-[#1B5E20] hover:bg-[#1B5E20]
                        hover:text-[#C8E6C9] flex p-2 rounded-md my-2 cursor-pointer "
                          onClick={(e) => {
                            router.push(
                              '/approverrequestgazservice/signdocumentgazservicer'
                            );
                          }}
                          data-title="อนุมัติ"
                        >
